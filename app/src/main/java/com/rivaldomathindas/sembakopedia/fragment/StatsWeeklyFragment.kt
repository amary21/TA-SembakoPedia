...
class StatsWeeklyFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mpWeekLineChartStatistics.data = data

        // custom chart
        mpWeekLineChartStatistics.setBackgroundColor(Color.WHITE)
        mpWeekLineChartStatistics.setGridBackgroundColor(Color.WHITE)
        mpWeekLineChartStatistics.description.isEnabled = false
        mpWeekLineChartStatistics.axisRight.setDrawLabels(false)
        mpWeekLineChartStatistics.setDrawGridBackground(true)
        mpWeekLineChartStatistics.setDrawBorders(true)
        mpWeekLineChartStatistics.setPinchZoom(false)
        mpWeekLineChartStatistics.setTouchEnabled(false)

        // remove legend
        val legend = mpWeekLineChartStatistics.legend
        legend.isEnabled = false

        // add cubic chart
        val xAxis = mpWeekLineChartStatistics.xAxis
