...
class StatisticsFragment : Fragment(), CategoryCallback {
    ...
    private fun initViews() {
        ...
        rvStatistics.layoutManager = LinearLayoutManager(requireActivity())
        rvStatistics.addItemDecoration(RecyclerFormatter.SimpleDividerItemDecoration(requireActivity()))
